                                    ...
                                    <section>                                    
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="tdGestion">Cantidad<input type="text" name="txtCant"></td>
                                                <td class="tdGestion">Precio de Compra<input type="text" name="txtPCompra"></td>                                                                                                                                                                          
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="tdGestion">Fecha de Entrada<input type="date" name="txtFechaIngreso" id="fechaActual"></td>
                                            </tr>                                            
                                            <tr>
