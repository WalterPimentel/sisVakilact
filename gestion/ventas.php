                                ...
                                <section>
                                    <table style="margin: auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="button" value="+ Agregar" name="btnAgregar" id="btnAgregar" class="btnAgregar" onclick="AgregarProductos(); setTimeout(mostrar, 150); setTimeout(actualizarStock, 200);"> </td>
                                        </tr>
                                    </table>
                                    <p>
