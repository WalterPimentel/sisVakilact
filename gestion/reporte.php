            ...
            <div class="divGestion">
                <div class="divRegsitro">                                                   
                    ...
                    <fieldset class="containerGestion">                            
                            <article>
                                <section>
                                    <form method="POST" action="fpdf/reportusers.php" target="_blank">
                                        <table>
                                            <tbody>
                                                <tr>
                            ...
                            <article>
                                <section>
                                    ...
                                    <?php  
                                        ...
                                        $tit = "Ingreso Productos";
                                        ?>
                    <h1>Reporte <?php echo $tit; ?> PDF</h1>
                    <fieldset class="containerGestion">                            
                            <article>
                                <section>
                                    <form method="POST" action="fpdf/reportproducts_in.php" target="_blank">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="tdGestion">Sede
                                                    ...
                                                    <td class="tdGestion">Nombre del producto entrante
